...
namespace OnlineEdu.DataAccessLayer.Migrations
{
    ...
    [Migration("20250423073504_create_table_coursevideo")]
    partial class create_table_coursevideo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseCourseVideo", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int");

                    b.Property<int>("CourseVideosCourseVideoId")
                        .HasColumnType("int");

                    b.HasKey("CourseId", "CourseVideosCourseVideoId");

                    b.HasIndex("CourseVideosCourseVideoId");

                    b.ToTable("CourseCourseVideo");
                });
            ...
            modelBuilder.Entity("OnlineEdu.EntityLayer.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineEdu.EntityLayer.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineEdu.EntityLayer.Entities.CourseRegister", b =>
                {
            ...
            modelBuilder.Entity("CourseCourseVideo", b =>
                {
                    b.HasOne("OnlineEdu.EntityLayer.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineEdu.EntityLayer.Entities.CourseVideo", null)
                        .WithMany()
                        .HasForeignKey("CourseVideosCourseVideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("OnlineEdu.EntityLayer.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("OnlineEdu.EntityLayer.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineEdu.EntityLayer.Entities.Blog", b =>
                {
                    b.HasOne("OnlineEdu.EntityLayer.Entities.AppUser", "AppUser")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("OnlineEdu.EntityLayer.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("OnlineEdu.EntityLayer.Entities.AppUser", "Student")
                        .WithMany()
